...
public class QueueService {
    private static final String AWS_ACCESS_KEY_ID = "AKIAI7JREURRAKWYBCTQ";
    private static final String AWS_SECRET_ACCESS_KEY = "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";
    ...
    public static void main(String[] args) throws Exception {
        QueueService sqs = new QueueService("mikeq");
