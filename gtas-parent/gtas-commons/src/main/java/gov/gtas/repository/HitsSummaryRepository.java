...
//	HitsSummary findByFlightIdAndPassengerId(Long flightId, Long passengerId);


	@Query("SELECT hits FROM HitsSummary hits WHERE hits.passengerId = :pid and hits.flightId = :fid")
